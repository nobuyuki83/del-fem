...
def test_01():
    ...
    Polyline.save_wavefront_obj(simulator.vtx2xyz_def, "../target/darboux_rod_static_rest.obj")
...
def test_02():
    ...
    for x in range(0,10):
        ...
        print(simulator.w)
    Polyline.save_wavefront_obj(simulator.vtx2xyz_def, "../target/darboux_rod_static_pull.obj")
...
def test_03():
    ...
    vtx2xyz_ini = Polyline.vtx2xyz_from_helix(30, 0.2, 0.2, 0.5)
    i_vtx_pull = 15
    pos_goal = vtx2xyz_ini[i_vtx_pull] + numpy.array([0., -0.5, 0.0])
    ...
    for x in range(0,300):
        ...
        print(simulator.w)
    Polyline.save_wavefront_obj(simulator.vtx2xyz_def, "../target/darboux_rod_dynamic.obj")
